...
const bmKeys = {};
let bmTouchDir = 0, bmTouchAtk = false, bmTouchJump = false, bmTouchDash = false;
...
const bmTouch = { left: false, right: false, jump: false, attack: false, dash: false };
...
function bmApplyTouches(e) {
  e.preventDefault();
  if (typeof initAudio === 'function') initAudio();
  const prev = { jump: bmTouch.jump, attack: bmTouch.attack, dash: bmTouch.dash };
